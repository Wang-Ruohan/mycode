...
void setup() {
  ...
  left_joint1.setAcceleration(1000);
  left_joint2.setAcceleration(1000);
  left_joint3.setAcceleration(1000);
  left_joint4.setAcceleration(1000);
  left_joint5.setAcceleration(1000);
  left_joint6.setAcceleration(1000);

  right_joint1.setAcceleration(1000);
  right_joint2.setAcceleration(1000);
  right_joint3.setAcceleration(1000);
  right_joint4.setAcceleration(1000);
  right_joint5.setAcceleration(1000);
  right_joint6.setAcceleration(1000);
...
void loop() {
   ...
   //限位开关到了极限位置，标志位+1
    ...
    if(R1_Flag==1){
     ...
     Serial.println(right_positions[0]);
