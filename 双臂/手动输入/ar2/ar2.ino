...
void setup() {
  ...
  // Configure each stepper 后面的注释是让他走了多少——对应多少度
  joint1.setMaxSpeed(10000);//13000——58.5°
  joint2.setMaxSpeed(1500);//2500——45°
  joint3.setMaxSpeed(2500);//1300——23.4°
  joint4.setMaxSpeed(10000);//1200——60.67°
  joint5.setMaxSpeed(3000);//500——24.12°
  joint6.setMaxSpeed(3000);//给1走0.259°
